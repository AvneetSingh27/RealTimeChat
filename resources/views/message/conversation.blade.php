    ...
    <script>
        $(function(){
            ...
            socket.on('updateUserStatus',(data)=>{
                ...
                let $userHeaderIcon = $('.user-status-head');
                $userHeaderIcon.removeClass('text-success');
                $userHeaderIcon.attr('title','Away');
                ...
                $.each(data, function(key,val){
                    if(val !== null && val !== 0){
                        ...
                        let $userHeaderStatus = $("#userStatusHead-"+key);
                        $userHeaderStatus.addClass('text-success');
                        $userHeaderStatus.attr('title','Online');
